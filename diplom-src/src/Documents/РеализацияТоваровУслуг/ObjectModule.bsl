...
Процедура ОбработкаПроведения(Отказ, Режим)
	...
	Движения.ВКМ_ВыставленныеРаботыПоАктам.Записывать = Истина;
	//--ВКМ_Очищаем результат прошлого проведения.
	...
	//++ВКМ_Формирование движений в РН_ВКМ_ВыставленныеРаботыПоАктам.
	Для Каждого ТекСтрокаУслуги Из Услуги Цикл
		
		Движение = Движения.ВКМ_ВыставленныеРаботыПоАктам.Добавить();
		Движение.Период = Дата;
...
Процедура ВКМ_ВыполнитьАвтозаполнение() Экспорт
	...
	Если НомАП <> НомРС Тогда
		...
		Результат = СтрШаблон("Проверьте наличие и соответствие номенклатуры в обеих константах!");
